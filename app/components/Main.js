...
class Main extends Component {
  ...
  searchArticles(searchTerm, limit, startYear, endYear) {
    ...
    API.getArticles(searchTerm, startYear, endYear).then((response) => {
		...
		return (
			<div className="container">
			    <div className="jumbotron">
			      <h1 className="text-center"><i className="fa fa-newspaper-o" aria-hidden="true"/> New York Times Search</h1>
			    </div>
			    <Search 
